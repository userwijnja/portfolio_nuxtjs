...
import { mergeProps, useSSRContext, onUnmounted, unref, withCtx, createVNode, openBlock, createBlock, Fragment, renderList } from "vue";
...
import { _ as _sfc_main$a } from "./Footer1-CPjMoQu_.js";
...
const _imports_0 = publicAssetsURL("/assets/vid/vid-startup.mp4");
const _sfc_main$5 = {};
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(unref(data), (item, index) => {
        _push(`<div class="${ssrRenderClass(`item ${index !== unref(data).length - 1 ? "mb-20" : ""} wow fadeInUp`)}"${ssrRenderAttr("data-wow-delay", `${index * 0.2 + 0.1}s`)}><div class="title"><h4>${ssrInterpolate(item.title)}</h4><span class="ico"></span></div><div class="accordion-info"><p>${ssrInterpolate(item.content)}</p></div></div>`);
      });
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_LandingWorks = _sfc_main$4;
      const _component_LandingMarquee = _sfc_main$3;
      const _component_LandingBrands = _sfc_main$2;
      const _component_LandingAccordions = _sfc_main$1;
...
//# sourceMappingURL=portfolio-CDFG3B-O.js.map
